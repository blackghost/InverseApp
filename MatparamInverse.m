function varargout = MatparamInverse(varargin)
% MATPARAMINVERSE M-file for MatparamInverse.fig
%      MATPARAMINVERSE, by itself, creates a new MATPARAMINVERSE or raises the existing
%      singleton*.
%
%      H = MATPARAMINVERSE returns the handle to a new MATPARAMINVERSE or the handle to
%      the existing singleton*.
%
%      MATPARAMINVERSE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MATPARAMINVERSE.M with the given input arguments.
%
%      MATPARAMINVERSE('Property','Value',...) creates a new MATPARAMINVERSE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MatparamInverse_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MatparamInverse_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MatparamInverse

% Last Modified by GUIDE v2.5 13-Dec-2012 15:12:08

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MatparamInverse_OpeningFcn, ...
                   'gui_OutputFcn',  @MatparamInverse_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MatparamInverse is made visible.
function MatparamInverse_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MatparamInverse (see VARARGIN)

% Choose default command line output for MatparamInverse
...
% UIWAIT makes MatparamInverse wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MatparamInverse_OutputFcn(hObject, eventdata, handles) 
