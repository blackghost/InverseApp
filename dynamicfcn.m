...
fit11=(a+bn(1)*power(strain,bn(2)))*(1+x*log(23/epsilon_0));
fit12=(a+bn(1)*power(strain,bn(2)))*(1+x*log(23/epsilon_0));
fitmean1=(a+bn(1)*power(strain,bn(2)))*(1+x*log(23/epsilon_0));
expmean1=(exp11(:,2)+exp12(:,2))/2;

exp21=load('dynamicPoint21.dat');
exp22=load('dynamicPoint22.dat');
fit21=(a+bn(1)*power(strain,bn(2)))*(1+x*log(43/epsilon_0));
fit22=(a+bn(1)*power(strain,bn(2)))*(1+x*log(45/epsilon_0));
fitmean2=(a+bn(1)*power(strain,bn(2)))*(1+x*log(44/epsilon_0));
expmean2=(exp21(:,2)+exp22(:,2))/2;

exp31=load('dynamicPoint31.dat');
exp32=load('dynamicPoint32.dat');
fit31=(a+bn(1)*power(strain,bn(2)))*(1+x*log(174/epsilon_0));
fit32=(a+bn(1)*power(strain,bn(2)))*(1+x*log(138/epsilon_0));
fitmean3=(a+bn(1)*power(strain,bn(2)))*(1+x*log(156/epsilon_0));
expmean3=(exp31(:,2)+exp32(:,2))/2;

exp41=load('dynamicPoint41.dat');
exp42=load('dynamicPoint42.dat');
fit41=(a+bn(1)*power(strain,bn(2)))*(1+x*log(338/epsilon_0));
fit42=(a+bn(1)*power(strain,bn(2)))*(1+x*log(324/epsilon_0));
fitmean4=(a+bn(1)*power(strain,bn(2)))*(1+x*log(331/epsilon_0));
expmean4=(exp41(:,2)+exp42(:,2))/2;

exp51=load('dynamicPoint51.dat');
exp52=load('dynamicPoint52.dat');
fit51=(a+bn(1)*power(strain,bn(2)))*(1+x*log(514/epsilon_0));
fit52=(a+bn(1)*power(strain,bn(2)))*(1+x*log(536/epsilon_0));
fitmean5=(a+bn(1)*power(strain,bn(2)))*(1+x*log(525/epsilon_0));
